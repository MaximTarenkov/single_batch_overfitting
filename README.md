...
Стандартные методы инициализации весов используют статистические распределения для предотвращения затухания или взрыва градиентов. Однако в сложных задачах, таких как моделирование естественного языка (LLM), модель с инициализацией из случайного шума тратит значительный вычислительный бюджет на первых этапах обучения лишь для того, чтобы усвоить базовые структурные паттерны (синтаксис, распределение токенов, закрытие тегов).
